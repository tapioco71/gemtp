...
module blkcom
  ...
  integer(4) :: ioutcs, idist, idistx(1), iofkol, iofkor, isw, itest
  integer(4) :: kbase, knt, kpen(5)
  integer(4) :: iaddrs, ichtr2, ipoint, itranm, ityold, iupper
  integer(4) :: jseedr
