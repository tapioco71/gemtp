...
module labcom
  ...
  real(8) :: spum(   30000)
  integer(4) :: kks(   43002)
  integer(4), target :: kknonl( 1032048)
  real(8) :: znonl( 1032048)
  real(8) :: znonlb(   43002)
  real(8) :: znonlc(   43002)
  real(8) :: finit(   43002)
  integer(4) :: ksub(     312)
  ...
  real(8), target :: e(   43002)
  real(8), target :: f(   43002)
  integer(4) :: kssfrq(   43002)
  integer(4) :: kode(   43002)
  integer(4) :: kpsour(   43002)
  real(8), target :: volti(    6000)
  real(8), target :: voltk(    3000)
  real(8), target :: volt(    6000)
  character(8) :: bus(   43002)
  integer(4), target :: karray(   43002)
  !
  real(8) :: emtpf(   43002)
  real(8) :: emtpe(   43002)
