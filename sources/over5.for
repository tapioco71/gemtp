...
3204 format (/, ' Error stop.   The node name  "bus3" on the last-read card is not that', /, &
          ' of any electric network node. bus3=', a6)
  go to 9600
205 jtmtac(n1) = 0
...
13204 format (/, ' Error stop.   The node name  "bus3" on the last-read card is not that', /, &
           ' of any electric network node. bus3=', a6)
  go to 9600
10205 jtmtac(n1) = 0
...
13207 format (/, ' Error stop.   The TACS name  "bus4" on the last-read card is', /, &
