...
9005 continue
  ...
  if(.not.((ndx.eq.3 .and. a.lt.b-p) .or.(ndx.eq.4 .and. a.le.b+p) .or.(ndx.eq.5 .and. a.gt.b+p) .or.(ndx.eq.6 .and. a.ge.b-p) &
       .or.(ndx.eq.1 .and. a.ge.b-p .and. a.le.b+p) .or.(ndx.eq.2 .and. (a.lt.b-p .or. a.gt.b+p)))) go to 5161
  c=one
  go to 5160
5161 continue
5160 continue
