...
4303 format (8x, '4.  A 3-phase saturable transformer has the aforementioned entries in the table for the three single-phase' ,/, &
          ...
          8x, 'h.  If a network uses one or more type-99 pseudo-nonlinear resistance elements which is not paralleled by another',/, &
...
4905 format (5x, 'beginning with "m32." versions,  list 7 storage of (ybb/ybc) is being, 38h destroyed,  and the full (y) is added',/, &
          5x,  'to the bottom of list 5 (fills from the bottom up).   The downward-growing, 37h factors spilled over onto (y) at row',/, &
