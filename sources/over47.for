...
285 format (18x, 'resistivity(Ohm-m)| core', e12.5, 3x, 'sheath', e12.5, 3x, 'armor', e12.5,, /, 18x, 'relative permeability |  ', &
      ...
      write(lunit6,393)
  393 format(1h0,10x,59hphysically inner conductors cannot be exsisted i
     1n the pipe.    /11x,56hplease check the radii of the pipe and inne
     2r conductors.   //,1x)
      call stoptp
  ...
  221 do 230 i=1,npc
      ...
      write(lunit6,289)
      call stoptp
  289 format(1h0,10x,38hinvalid data of 'ncpp(i)', no further
     1,50hcalculation.  it should be 'ncpp(i-1).ge.ncpp(i)'.
     2/11x,23hplease check your data.  )
  223 continue
  ...
  230 continue
      if (iprs47 .gt. 1)
     1 write (lunit6, 2437)  npc, ncc, npp, ncct, numaki, lastov,
     2  ipunch, ialter, iearth, itypec, isyst, kmode, izflag, iyflag
 2437 format ( /,  18h various integers.,
     1  40h     npc     ncc     npp    ncct  numaki,
     2  40h  lastov  ipunch  ialter  iearth  itypec,
     3  32h   isyst   kmode  izflag  iyflag  ,/,  18x,  14i8  )
      if ( iprsup  .ge.  2 )
     1 write (lunit6, 2441)  ( i, bi1(i), bi2(i), bi3(i),
     2                         al1i(i), al2i(i), i=1, npc )
 2441 format ( /, 75h derived vectors of length  'npc'  in  'subr47' ,
     1 as matrix grunt begins.  ,/,  1x,  5x,  3hrow,  17x,  3hbi1,
     2  17x,  3hbi2,  17x,  3hbi3,  16x,  4hal1i,  16x,  4hal2i  ,/,
     3 ( 1x,  i8,  5e20.11 )  )
 ...
 1711 write (lunit6, 917) freq, ik, ips
     ...
     1  hyud2, hyud3, hyud4
  700 if ( iprsup  .ge.  3 )
     1 write (lunit6, 1714) (i, rad(i), radp(i), di(i), hi(i), i=1, nw)
 1714 format ( /,   25h before call to  'simp' .,  7x,  1hi,
     1 12x,  3hrad,  11x,  4hradp,  13x,  2hdd,  14x,  1hh  ,/,
     2 ( 25x,  i8,  4e15.6 )  )
  ...
  919 format(1h0,10x,45hdata cards by pi-circuit modeling are punched,
     1 51h out for the following specifications ; node name ',a1,1h' )
  920 format(10x,31htotal length of overhead line =, e12.5/10x,
     1 26hlength of one pi-section = , e12.5,3x,
     2 23hnumber of pi sections = ,i3  )
  921 format(10x,23htotal length of cable = ,e12.5  /10x,
     1 29hlength of one major section = ,e12.5,3x,
     2 26hnumber of major sections = ,i3 /10x,
     3 46hsheath grounding resistance at major section ; ,e12.5)
  922 format(10x,23htotal lrngth of cable = ,e12.5  /10x,
     1 29hlength of one major section =  ,e12.5,3x,
     2 26hnumber of major sections = ,i3   )
  923 format(10x,25hthe cable is crossbonded.   )
  924 format(10x,28hdiscrete pi-circuit modeling  )
  925 format(10x,31hhomogeneous pi-circuit modeling   )
 ...
 1719 format ( /, 24h after call to  'simp' .,
     1 56h      nw      nz   isyst  itypec  iearth     npc     ncc  ,/,
     2 24x,  7i8  )
      write (lunit6, 1721)  (  ( zy(i,j), j=1, nw),  i=1, nw )
 1721 format ( /, 30h ((zy(i,j), j=1, nw), i=1, nw)  ,/, ( 1x, 8e15.8) )
 1750 call ymatrx(isyst, lunit6, ncpp, zy, yz, esi, al0, al1i, al2i,
     1     al3i, yzn(1), yzn(lnq1), ldm, ldn)
      if (kill .ge. 1) go to 9200
      if (iprsup .ge. 3)
     1     write (lunit6, 1723)  ((yz(i, j), j = 1, nz), i = 1, nz)
 1723 format ( /,  58h ((yz(i,j), j=1, nz), i=1, nz)   after call to  'y
     1matrx' .  ,/,  ( 1x,  8e15.8 )   )
      do 702  i=1, nz
         do 702  j=1, nz
            if ( j  .lt.  i )   go to 702
 ...
 702  continue
      ...
      if (isyst .eq. 2)
     1     call transp(ys, ncpp, yzn(1), yzn(ldn2), ca, ldm, ldn)
      if (kill .ge. 1)   go to 9200
 703  do 705  i=1, nz
         do 705  j=1, nz
            if ( j  .lt.  i )   go to 705
  ...
  705 continue
      ...
      if(npais.ne.0)
     1     call gomen(itypec,npc,nx,npais,ncros,irsep,ncpp,ldm)
      if ( iprsup  .ge.  3 )
     1     write (lunit6, 2457)  ( ( yz(i,j), j=1, nz), i=1, nz )
 2457 format (/, " in  'subr47' ,   capacitance.   ( (yz(i,j), j=1, n
     1z), i=1, nz )    ", /, (1x, 6e20.11))
      iprint = 0
 9003 continue
 ...
 7449 if ( ialter  .eq.  2 )
     1     roe    = ci1
      ...
      kkk = 1
      if ( iprsup  .ge.  1 )
     1     write (lunit6, 2469)  nz, ik, ialter, iprsup, roe, ci1,
     2     ck1, dist, yz(1,1), yz(1,2)
 2469 format ( /, 40h in  'subr47' ,   done with capacitance.,
     1     32h      nz      ik  ialter  iprsup  ,/,
     2     40x,  4i8  ,/,  1x,  17x,  3hroe,  17x,  3hci1,
     3     17x,  3hck1,  16x,  4hdist,  13x,  7hyz(1,1),  13x,  7hyz(1,2)
     4     ,/,  1x,  6e20.11  )
      ...
      l0 = 0
      d9 = dist * tenm3
ccc   write (*,*)  ' %%-- guts47 write on  lunit9.',
ccc   1             '    dist, d9, =',  dist, d9,
...
23006 format(/, 63h next logarithmacally spaced frequency.  iprint     k
     1kk     iii, 11x, 4hfreq,12x, 3hci1,12x,3hck1,/,39x,3i8,3e16.6)
 3007 if (numaki .eq. 9)  go to 730
      text4 = text2
      if ( itypec .ne. 1 )  text4 = text3
      write (lunit6, 941)  text4, freq
  941 format ( //, 20h *******************  ,  a6,
     1             35h constants matrices for frequency =,
     2   e15.6,    40h hz   ********************************** )
  730 w = freq * twopi
      if (numaki .eq. 1)   freqs = freq
      call zymx( w,nz,isyst,ngrnd, ngg,ncpp, radi,zy,yz,dir,dij,
     1  ang,usi,usr,esi,dr0,th0,al0,hi,di,bio,bi1,bi2,bi3,bi4,bi5,
     2  al1i,al2i,al3i,dci,  nx, yzn,    ys,yc,zp,zpc,zs,ze,zc,
     3  ca,cb,cc,cd,f,  ldm, ldn, ldn2, lnq2 )
  800 if(npais.eq.0) go to 810
      write(lunit6,951)
      npk = lnq2 / 3
      nki = npk + 1
      nkj = nki + npk
      call datout(w, zc, yc, rsg, xmajor, nx, npais, ncros, irsep,
     1     cname, ldn, yzn(1), yzn(nki), yzn(nkj), npk)
 951  format(//1h0,10x,41h*****lists of punched out data cards***** )
 810  continue
      if (kill .ge. 1)   go to 9200
      if (kmode .eq. 0)   go to 750
      ktab = nx
      call prcon( w, nx, zc,zs,ys,yc,yo,qn,gn,ze,a,ai,b,bi,
     1 yzn, ca, cb, cc, f, ldn, ldn2, lnq2, mrr, nrp )
      if (kill .ge. 1)   go to 9200
      ...
      liu = 1
      if (iprs47 .ge. 1)
     1 write(lunit6, 1745)  freq, cczero
 ...
 2745 rzero = realz(zs(1,1))
      ...
      if (iprs47 .ge. 1)
     1 write (lunit6, 3745)  rzero, xzero, freq
...
c!                                            ** identical eigenvalue ?
 ...
 9004 continue
      ...
      backspace junit4
 9005 continue
      write (*,*) ' backspace junit4.  junit4, iprint =',
     1                                 junit4, iprint
      iprint=1
      go to 9003
 9002 continue
...
!     read input card using cimage.
 ...
 9200 lstat(18) = nchain
     ...
     1 lunit5 = l5save
      ...
      nchain=51
 9900 if ( iprsup  .ge.  1 )
     1 write (lunit6, 2592)  nchain, lunit5, numaki, ialter
 2592 format ( /,  17h exit  'subr47' .,
     1  32h  nchain  lunit5  numaki  ialter  ,/,  17x,  4i8  )
      return
      end
 ...
 1001 format ( 33h  begin module "crosa4".  ******  )
   ...
   30 continue
      ...
      czy(j,i) = czy(i,j)
   60 continue
      if(icont.eq.0) call minvn( czy,6,3,0,ldn,
     1               ca,cb,cc,cd,ce,cf,cg,f,ldn2 )
      do 70 j = 1,3
      czy(4,j) = czy(4,j) + czy(5,j) + czy(6,j)
      czy(j,4) = czy(j,4) + czy(j,5) + czy(j,6)
   70 continue
      czy(4,4) = czy(4,4) + czy(5,4) + czy(6,4)
     1         + czy(4,5) + czy(5,5) + czy(6,5)
     2         + czy(4,6) + czy(5,6) + czy(6,6)
      if(icont.eq.0) call minvn( czy,4,3,0,ldn,
     1               ca,cb,cc,cd,ce,cf,cg,f,ldn2 )
      return
      end
      subroutine minvn( cinout, n, l, ix, ldn, ca, cb, cc, cd,
     1                  cwork1, cwork2, cwork3, f, ldn2 )
      implicit real*8 (a-h, o-z) ,
     1      integer*4 (i-n)
      complex*16  ca(ldn,ldn),cb(ldn,ldn),cc(ldn,ldn),cd(ldn,ldn)
...
c
 ...
 8200 format(1h0,10x,46hin the case of 'npais.ge.0 .and. ncros.ne.0',
     ...
     1               40hth armor and '1' for a pt cable.  if a 3,
     1               40h-phase sc cable with armor is enclosed  /
     1       1h ,10x,39hwithin a pipe (i.e., pt cable), please  ,
     1               40hnegrect the pipe, i.e., regard as an sc ,
     1               40hcable with 'ngrand'='3', considering the/
     1       1h ,10x,38hfact that all the 3-phase cables have   ,
     1               40hthe same configuration.                 )
      call stoptp
 9300 continue
      write(lunit6,7000)
      write(lunit6,8300)
 8300 format(1h0,10x,40heach cable of a 3-phase cable system has,
     1               40h the same configulation in general. if n,
     1               40hot, please arrange the data cards as    /
     1       1h ,10x,40hfollows : first comes a cable of which t,
     1               40hhe number of conductors is smallest, sec,
     1               40hond comes a cable of the second smallest/
     1       1h ,10x,40hnumber of conductors,.... please check y,
     1               40hour data.                               )
      call stoptp
      return
 7000 format(1h0,10x,40herrors for a crossbonded cable (ncros.ne,
     1               40h.0) when 'npais'='0'.                   )
      end
 ...
 8010 format(1h0,10x,40hin the case of 'npais.lt.0.and.ncros.ne.,
     1               40h0' the final number of conductors includ,
     1               40hing grounded conductors reduction should/
     1       1h ,10x,40hbe 6 or 7, i.e., 'total number of conduc,
     1               40htors of the cable system'-'ngrnd'='6' or,
     1               40h '7', but 'ngrnd' should be '1' for a pt/
     1       1h ,10x,40hcable.                                  )
      call stoptp
 9020 continue
      write(lunit6,8020)
 ...
 8030 format(1h0,10x,40hnumber of conductors in one phase should,
     1               40h be '2' (core and sheath) with 'ngrnd'=',
     1               40h0' for an sc cable and 'ngrnd'='1' for a/
     1       1h ,10x,40hpt cable, or '3' (core, sheath and armor,
     1               40h) with 'ngrnd'='3' for an sc cable.     )
      call stoptp
 9040 continue
      write(lunit6,8040)
 ...
 8050 format(1h0,10x,40hin the case of 'npais.lt.0', the final n,
     1               40humber of conductors including grounded c,
     1               40honductors reduction should not be       /
     1       1h ,10x,41hgreater than '7'. please check your data.)
      call stoptp
 9060 continue
      write(lunit6,8060)
 8060 format(1h0,10x,40hin the case of 'npais.lt.0', the final n,
     1               40humber of conductors including grounded c,
     1               40honductors reduction should not be '1' or/
     1       1h ,10x,40h'4' or '5'. please check your data.            )
      call stoptp
 9070 continue
      write(lunit6,8070)
 8070 format(1h0,10x,40hin this case, it should not be 'irsep=0',
     1               40hplease change 'irsep=1'                 )
      call stoptp
 9080 continue
      write(lunit6,8080)
 8080 format(1h0,10x,40hin this case, number of phases (npc) sho,
     1               40huld only be '1'. please check your data.)
      call stoptp
 9090 continue
      write(lunit6,8090)
 8090 format(1h0,10x,40hsorry, in the case of 'npais.lt.0', a tw,
     1               40ho phase cable (npc=2) consisting only of,
     1               40h core or consisting of core and sheath  /
     1       1h ,10x,40hcan not be dealt with. please check your,
     1               40hdata.                                   )
      call stoptp
 9110 continue
      write(lunit6,8110)
 8110 format(1h0,10x,40hin this case, ncpp(2) should be '2' plea,
     1               40hse check your data.                       )
      call stoptp
 9120 continue
      write(lunit6,8120)
 8120 format(1h0,10x,34hinthe case of 'npais.gt.0.and.ncro,
     1               34hs.eq.0', it should not be 'irsep=1,
     1               34h',please change 'irsep=0'.        )
      call stoptp
      return
      end
     ...
     1      integer*4 (i-n)
      ...
      cjw = cmplxz ( fzero, w )
      if ( iprs47  .ge.  1 )
     1 write (logsix, 2624)  nconpw, numaki, value1, value3, pai, cjw
 2624 format ( /,  17h enter  'prcon' .,  16h  nconpw  numaki,
     1  13x,  6hvalue1,  13x,  6hvalue3,  16x,  3hpai,
     2  11x,  8hreal-cjw,  11x,  8himag-cjw  ,/,  17x,  2i8,  5e19.10 )
      ll1 = 1
      ll2 = 2
...
cccc  *****
   ...
   61 qn(i) = qn(i1)
      icorr = 1
      write(lunit6, 901)  i
  901 format (1h0, 42hmodifications of modal quantities for mode,
     1  i2, 10h are made. /)
      go to 65
   63 i1 = i + 2
  ...
  961 format (1h0, 10x, 33hmodification for imag(q) is made.  //, 1x)
      go to 55
   50 write(lunit6, 962)
  962 format (1h0, 10x, 49hconductor impedance may include numerical err
...
!     ea=2.0*atan2z( aimag(qn(i)),real(qn(i)) )
 ...
 5701 continue
      if ( iprsup .ge. 1 )
     1 write(*,*) ' prcon after s.n. 5701.   [a]  follows ....'
      do 7801  i=1,nconpw
      if ( iprsup .ge. 1 )
     1 write(*,*) (a(i,j), j=1,nconpw)
 7801 continue
      call minv( ai, nconpw, f, ldn, ldn2 )
      if ( iprsup .ge. 1 )
     1 write(*,*) ' after "minv".   [ai]  follows ..... '
      do 7802 i=1,nconpw
      if ( iprsup .ge. 1 )
     1 write(*,*) (ai(i,j), j=1,nconpw)
 7802 continue
      do 5611 i=1,nconpw
      do 5621 j=1,nconpw
 ...
 5810 continue
      if ( iprsup .ge. 1 )
     1 write (*, *) ' prcon.  use normalization cells kmax(1:nconpw) =',
     1                          ( kmax(i), i=1,nconpw )
      do 5614 j=1,nconpw
...
c   ******************** temporary diagnostic ************
      if ( iprsup .ge. 0 )
     1 write (*, *) ' prcon.  freq =',  fout, '     pp1 follow : '
      do 7701 i=1,nconpw
      if ( iprsup .ge. 0 )
     1 write (*, *) ( pp1(i,j), j=1, nconpw )
 7701 continue
      if ( iprsup .ge. 0 )
     1 write (*, *) ' pp2  follow ... '
      do 7702 i=1,nconpw
      if ( iprsup .ge. 0 )
     1 write (*, *) ( pp2(i,j), j=1,nconpw )
 7702 continue
      do 6004 i=1,nconpw
      do 6004 j=1,nconpw
 ...
 1470 continue
      ...
      write (lunit6, 2953)
 2953 format (  /, 10x, 'voltage transformation matrices in polar',
     1                  ' coordinates (with angles in degrees).'
     2   ,/, 15x, ' inverse of [tv] --- from phase to mode domain:'  )
...
!    **********  thlthl
 ...
 1980 continue
  ...
  305 format(//, 53x, 27h table of modal quantities.)
      write (lunit6, 315)
  315 format(//,11x, 5hmodal,4x, 11hpropagation, 7x, 15hmodal impedance,
     112x, 5hmodal, 6x, 26hcharac. imp., natural mode, 4x, 26hcharac. ad
     2m., natural mode,/, 5h mode, 3x, 22hattenuation   velocity, 7x,
     3 4hreal, 7x, 9himaginary, 4x, 11hsusceptance,7x, 4hreal, 8x, 9hima
     4ginary, 9x, 4hreal, 8x, 9himaginary,/,10x, 7h(db/km), 6x, 5h(m/s),
     5 12x, 8hz(ohm/m), 14x, 10himy(mho/m), 9x, 17hsqrt(z/y) (ohm)  ,
     6 13x, 17hsqrt(y/z) (mho)  )
      do 205   i=1, nconpw
      zsr    = realz(zs(i,i))
      zsi   = aimagz(zs(i,i))
      ysi    = aimagz(ys(i,i))
      ...
      yor     = realz(yo(i,i))
      yoi     = aimagz(yo(i,i))
      write (lunit6, 325)  i, an(i), gn(i), zsr, zsi, ysi, zor, zoi, yor
     +, yoi
 ...
 2689 format ( /,  16h exit  'prcon' .  )
     ...
     1      integer*4 (i-n)
      include  'blkcom.ftn'
ccccc %include  '//a/tsu/tpplotkom.ins.ftn'
...
cccc!      sb(i)=bom(i)
  ...
  701 continue
      if ( iprsup .ge. 1 )
     1 write (*,*) ' beginning  bom(1:4*li) =',  ( bom(ip), ip=1, 4*li )
c   * process the data between freq, freq-1 & freq-2 *
      do 101 j=2, kpt-2, 4
      do 102 i=j+4, kpt-2, 4
c   * test the crossing of ang *
      ...
      if ( d1*d2 .le. 0. ) go to 801
      go to 102
c   * test the slope change of ang , if switching *
  801 continue
      aj=0.
      ai=0.
      ...
      if ( iprsup .ge. 1 ) write (*,*) ' smj1, smj2, smi1, smi2 =',
     1                                   smj1, smj2, smi1, smi2
...
c   * switching *
  ...
  101 continue
      ...
      go to 99
   12 continue
cc  **  begin the second loop for vel and db  **
c   * test the slope change of vel *
      ic=0
      iq=0
...
c   * test the slope change of vel *
      ...
      saj=(bom(jbeg)-bom(jbeg+kpt))/
     1 ((bom(jbeg+kpt)-bom(jbeg+2*kpt))+aj)
      if ( abs( saj - 1 ) .gt. 0.5 ) go to 8001
 8901 continue
      go to 812
 8001 do 8101 j=jbeg, kpt-1, 4
      do 8102 i=j+4, kpt-1, 4
c   * test the crossing of vel or db *
      jb=(j+1)/4
      ib=(i+1)/4
      d1=bom(j+kpt) - bom(i+kpt)
      d2=bom(j) - bom(i)
...
!      go to 8102
 ...
 8101 continue
      ...
      go to 899
  812 continue
c   * check the equality between two eigenvalues *
      if(nrp.eq.1) go to 2030
      ku=0
      kunf=0
      do 1004 j=1, kpt-3, 4
      mu=0
      do 1005 i=j+4, kpt-3, 4
      if((abs(bom(j)-bom(i)).gt.abs(bom(j)*1e-6)).or.
     1 (abs(bom(j+1)-bom(i+1)).gt.abs(bom(j+1)*1e-6)))go to 1005
...
ccc!     1 (bom(j+1+kpt).ne.bom(i+1+kpt))) go to 1005
 ...
 1005 continue
      ...
      ku=ku+1
      if ( iprsup .ge. 1 )
     1 write (*,*) ' identical eigenvalues.   j, ku, kuid(1:ku) =',
     2                                j, ku, ( kuid(ip), ip=1, ku )
 1004 continue
...
c   * re-ordering, if necessary *
 ...
 2005 continue
      if ( iprsup .ge. 1 )
     1 write(*,*) ' end of unwind.  vfreq(1) =',  vfreq(1)
      if ( iprsup .ge. 1 )
     1 write(*,*) ' end of unwind.   iseq(1:li) =', (iseq(l),l=1,li)
      if ( iprsup .ge. 1 )
     1 write(*,*) ' end of unwind.   kthl, mrr, nrp, ntol =',
     2                               kthl, mrr, nrp, ntol
   11 continue
      do 2001 i=1,kpt
      ping(i+1)=bom(i)
...
cc!      write(*,*) 'done with unwind '
     ...
     1  dij,ang,usi,usr,esi,dr0,th0,al0,hi,di,bio,bi1,bi2,bi3,bi4,
     2  bi5,al1i,al2i,al3i,dci, nx, yzn,   ys,yc,zp,zpc,zs,ze,zc,
     3  ca,cb,cc,cd,f, ldm, ldn, ldn2, lnq2 )
      implicit real*8 (a-h, o-z) ,
     1      integer*4 (i-n)
      include  'blkcom.ftn'
    ...
    5 ze(i,j) = czero
      ...
      ll2 = 2
      if ( iprs47  .ge.  1 )
     1 write (logsix, 2706)  nw, isyst, np2, itypec, numaki, npc,
     2                       ncc, izflag, iyflag, w
 2706 format ( /,  16h begin  'zymx' .,  24h      nw   isyst     np2,
     1  48h  itypec  numaki     npc     ncc  izflag  iyflag,
     2  19x, 1hw, /, 16x, 9i8, e20.11 )
      go to  (710, 720, 30), itypec
  710 call  olzy ( w,ncpp,zy,dij,ang,usi,usr,esi,hi,di,zs,ze,zc,
     1             ldm, ldn )
      if (kill .ge. 1)   go to 9200
      go to 800
  720 call  sczy1 ( w, isyst, zy, dir, dij, ang, hi, di, zs, ze,
     1              ldm, ldn )
      if (kill .ge. 1)   go to 9200
      call  sczy2 ( cjw, ncpp, radi, usi, usr, bio, bi1,
     1  bi2, bi3, bi4, bi5, al1i, al2i, al3i, zc, ldm, ldn )
      if (kill .ge. 1)   go to 9200
      go to 800
   30 if ( npp  .ne.  0 )
     1 call  sczy1 ( w, isyst, zy, dir, dij, ang, hi, di, zs, ze,
     2               ldm, ldn )
      if (kill .ge. 1)   go to 9200
      call  sczy2 ( cjw, ncpp, radi, usi, usr, bio, bi1,
     1  bi2, bi3, bi4, bi5, al1i, al2i, al3i, zc, ldm, ldn )
 ...
 1966 if ( i  .gt.  1 )  go to 1945
  ...
  335 nx = nw
  340 if (isyst .eq. 2)
     1  call transp(zc, ncpp, yzn(1), yzn(ldn2), ca, ldm, ldn)
      if (kill .ge. 1)   go to 9200
 ...
 1900 format ( 30h  y written on lunit3 at freq , e16.7,2x,
     1 3hare,/, (1x,8e15.6) )
 1983 k = 1
      do 1918  j = 1, n1
      do 1919  i = 1, n1
 ...
 2010 format ( 30h  z written on lunit3 at freq , e16.7,2x,
     1 3hare,/, (1x,8e15.6) )
...
!     now restore  'yc'  to admittance in  do 4928  loop below.
 ...
 2794 format ( /,  15h exit  'zymx' .  )
      ...
      subroutine ymatrx (isyst, lunit6, ncpp, zy, yz,
     1   esi, al0, al1i, al2i, al3i, a1, a2, ldm, ldn )
      implicit real*8 (a-h, o-z) ,
     1      integer*4 (i-n)
      include  'labl47.ftn'
   ...
   10 continue
      if ( iprs47  .ge.  1 )
     1 write (lunit6, 1719)  isyst, np2, itypec, npc, npp
 1719 format ( /,  28h at beginning of  'ymatrx' .,
     1 40h   isyst     np2  itypec     npc     npp    ,/,
     2 28x,  5i8  )
      if ( iprs47  .ge.  2 )
     1 write (lunit6, 1724)  ( i, ncpp(i), al1i(i), al2i(i), al3i(i),
     2 esi(i,1), esi(i,2), esi(i,3), i=1, 10)
 1724 format ( /,  5x,  3hrow,  4x,  4hncpp,  11x,  4hal1i, 11x,4hal2i,
     1 11x,  4hal3i,  7x,  8hesi(i,1),  7x,  8hesi(i,2),7x,8hesi(i,3),/,
     2 ( 1x, i7, i8, 6e15.6 )   )
   ...
   90 continue
  200 if ( iprs47  .ge.  1 )
     1 write (logsix, 2876)  ncc, ypo1, es1, alpi, yz(1,1), yz(1,2)
 2876 format ( /,  17h exit  'ymatrx' .,  8h     ncc,  16x,  4hypo1,
     1  17x,  3hes1,  16x,  4halpi,  13x,  7hyz(1,1),
     2  13x,  7hyz(1,2)  ,/,  17x,  i8,  5e20.11  )
      return
      end
     ...
     1      integer*4 (i-n)
      ...
      if ( iprs47  .ge.  1 )
     1 write (logsix, 2924)  nw, itypec, h(1), dd(1), dd(2), rad(1),
     2                       radp(3)
 2924 format ( /,  16h enter  'simp' .,  16h      nw  itypec,
     1 16x,  4hh(1),  15x,  5hdd(1),  15x,  5hdd(2),  14x,  6hrad(1),
     2 13x,  7hradp(3)  ,/,  16x,  2i8,  5e20.11 )
      do 5  i=1, nw
      do 5  j=1, nw
      dij(i,j) = 0.0
      dir(i,j) = 0.0
   ...
   30 continue
      if ( iprs47  .ge.  1 )
     1 write (logsix, 2936)  dir(1,2), dij(1,2), v, zy(1,1), zy(1,2)
 2936 format ( /,  15h exit  'simp' .,  12x,  8hdir(1,2),
     1 12x,  8hdij(1,2),  19x,  1hv,  13x,  7hzy(1,1),
     2 13x,  7hzy(1,2)  ,/,  15x,  5e20.11 )
      if ( iprs47  .ge.  5 )
     1 write (logsix, 2948)  ( ( zy(i,j), j=1, nw ),  i=1, nw )
 2948 format ( /,  47h exit  'simp' .   ((zy(i,j), j=1, nw), i=1, nw)
     1 ,/,  ( 1x,  6e20.11 ) )
      return
      end
     ...
     1      integer*4 (i-n)
      ...
      cjw = cmplxz ( fzero, w )
      if ( iprs47  .ge.  1 )
     1 write (logsix, 3027)  isyst, npc, iearth, itypec, roe, u0, w
 3027 format ( /,  17h enter  'sczy1' .,
     1 32h   isyst     npc  iearth  itypec,  17x,  3hroe,  18x,  2hu0,
     2 19x, 1hw, /, 17x, 4i8, 3e20.11 )
      c2 = u2p * zy(1,1)
   ...
   40 continue
      if ( iprs47  .ge.  2 )
     1 write (logsix, 3039)
 3039 format ( /,  44h diagnostic within  'sczy1' ,   ze(i,j)  for,
     1  18h(i,j)=1, ... npc .    )
      ll0 = 0
      if ( iprs47  .ge.  4 )
     1 call print ( ze(1,1), npc, ll0, ldn )
   ...
   70 ze(i,j)=xe
   90 if ( iprs47  .ge.  2 )
     1 write (logsix, 3056)  xe
 3056 format ( /,  45h diagnostic at exit  'sczy1' .   zs(i,j)  for,
     1  33h  (i,j)=1, ... npc .    real-xe =,  e20.11,
     2 4x,  9himag-xe =,  e20.11 )
      if ( iprs47  .ge.  4 )
     1 call print ( zs(1,1), npc, ll0, ldn )
      return
      end
      subroutine  sczy2 ( s, ncpp, radi, usi, usr, bio, bi1,
     1  bi2, bi3, bi4, bi5, al1i, al2i, al3i, zc, ldm, ldn )
      implicit real*8 (a-h, o-z) ,
     1      integer*4 (i-n)
      include  'labl47.ftn'
      ...
      ll2 = 2
      if ( iprs47  .ge.  1 )
     1 write (logsix, 3107)  npc, s
 3107 format ( /,  17h enter  'sczy2' .,  8h     npc,  14x,  6hreal-s,
     1 14x,  6himag-s  ,/,  17x,  i8,  2e20.11 )
 1001 inm=0
      do 100 i=1,npc
      b0=bio(i)
      b1=bi1(i)
      ...
      su0=s*c1
      if ( iprs47  .ge.  2 )
     1 write (logsix, 3124)  i, b0, su0, s0
 3124 format ( /,  20h re-loop over  'i' .,  8h       i,  18x,  2hb0,
     1 12x,  8hreal-su0,  12x,  8himag-su0,  13x,  7hreal-s0,
     2 13x,  7himag-s0  ,/,  19x,  i8,  5e20.11 )
   ...
   25 d1 = usi(i,1)*al1
      ...
      z23 = su0 * c1
      if ( iprs47  .ge.  3 )
     1 write (logsix, 3136)  ixa, ncpp(i), radi(i,1), z11, z12
 3136 format ( /,  1x,  16h     ixa ncpp(i),  11x,  9hradi(i,1),
     1 12x,  8hreal-z11,  12x,  8himag-z11,
     2 12x,  8hreal-z12,  12x,  8himag-z12  ,/,  1x,  2i8,  5e20.11 )
      z3i = czero
      z3m = czero
      z3o = czero
      d1 = usi(i,3) * al3
   ...
   42 s7=su0/s2*s1/s0*c1
      ...
      z3m = czero
   44 if ( iprs47  .ge.  3 )
     1 write (logsix, 3148)  z2i, z2o, z2m, z23
 3148 format ( /,  1x,
     1 8x,  8hreal-z2i,  8x,  8himag-z2i,
     2 8x,  8hreal-z2o,  8x,  8himag-z2o,
     3 8x,  8hreal-z2m,  8x,  8himag-z2m,
     4 8x,  8hreal-z23,  8x,  8himag-z23  ,/,  1x,  8e16.7  )
   ...
   90 s1=z11+z12+z2i
      ...
      zc(i2,i1)=s5
      if ( iprs47  .ge.  3 )
     1 write (logsix, 3159)  s1, s2, zc(i,i), zc(i,i1)
 3159 format ( /,  21h store  'zc'  values.,
     1 13x,  7hreal-s1,  13x,  7himag-s1,
     2 13x,  7hreal-s2,  13x,  7himag-s2  ,/,  21x,  4e20.11  ,/,
     3 8x,  12hreal-zc(i,i),  8x,  12himag-zc(i,i),
     4 7x,  13hreal-zc(i,i1),  7x,  13himag-zc(i,i1)  ,/,
     5 1x,  4e20.11 )
  100 continue
      if ( iprs47  .ge.  1 )
     1 write (logsix, 3174)
 3174 format ( /,  16h exit  'sczy2' .   )
     ...
     1      integer*4 (i-n)
      ...
      if ( iprs47  .ge.  1 )
     1 write (logsix, 3238)  npp, npc, bp1, bp2, radp(3)
 3238 format ( /,  17h begin  'ptzy1' .,  16h     npp     npc,
     1 17x,  3hbp1,  17x,  3hbp2,  13x,  7hradp(3)  ,/,
     2 17x,  2i8,  3e20.11 )
      if (npp .eq. 0)   go to 5
   ...
   70 continue
      if ( iprs47  .ge.  1 )
     1 write (logsix, 3256)  dkl, cn, alpi, al0(1,1), al0(1,2)
 3256 format ( /,  16h exit  'ptzy1' .,  17x,  3hdkl,  18x,  2hcn,
     1 16x,  4halpi,  12x,  8hal0(1,1),  12x,  8hal0(1,2)  ,/,
     2 16x,  5e20.11 )
      if ( iprs47  .ge.  4 )
     1 write (logsix, 3263)  ( (al0(i,j), j=1, npc), i=1, npc )
 3263 format ( /,  63h diagnostic output matrix.    ( (al0(i,j), j=1, np
     1c), i=1, npc)     ,/,  ( 1x,  6e20.11 ) )
      return
      end
     ...
     1      integer*4 (i-n)
      ...
      if(xa.gt.10.) ixa=1
      if ( iprs47  .ge.  1 )
     1 write (logsix, 3316)  npc, npp, xa, alpi, s
 3316 format ( /,  17h begin  'ptzy2' .,  16h     npc     npp,
     1 18x,  2hxa,  16x,  4halpi,  14x,  6hreal-s,  14x,  6himag-s
     2 ,/,  17x,  2i8,  4e20.11 )
   ...
   42 if (ixa .eq. 1) go to 45
      ...
      zm = c6/ss
      zzo =su0*c3/s2*(s4*bkn(2)+s5*bin(2)
     1     )/ss+zzo
   ...
   45 s6 = s2 - s1
      ...
      zm = c6/ss
      zzo=su0*c3/s2*(s4*bkn(2)*s6+s5*bin(2)/s6)
     1    /ss+zzo
   ...
   30 continue
      if ( iprs47  .ge.  2 )
     1 write (logsix, 3327)  ( zp(1,j), j=1, 3 )
 3327 format ( /,  8h middle.,
     1  8x,  12hreal-zp(1,1),  8x,  12himag-zp(1,1),
     2  8x,  12hreal-zp(1,2),  8x,  12himag-zp(1,2),
     3  8x,  12hreal-zp(1,3),  8x,  12himag-zp(1,3)  ,/,
     4  8x,  6e20.11  ,/,
     5  46h diagnostic   zp(i,j)  for  (i,j)=1, ... npc .   )
      ll0 = 0
      if ( iprs47  .ge.  5 )
     1 call print ( zp(1,1), npc, ll0, ldn )
      if ( npp  .eq.  0 )   go to 90
      s1=zzi+zzo-2.*zm
      s2=zzo-zm
      s3 = cimag1
      ...
      if ( iprs47  .ge.  3 )
     1 write (logsix, 3345)  ss, zm, zzo
 3345 format ( /,  6h pipe.,
     1  13x,  7hreal-ss,  13x,  7himag-ss,
     2  13x,  7hreal-zm,  13x,  7himag-zm,
     3  12x,  8hreal-zzo,  12x,  8himag-zzo  ,/,  6x,  6e20.11 )
      nc1=ncc-npp
      if (iprs47 .gt. 1)
     1 write (logsix, 3354)  ncc, nc1, ixa, s1, s2
 3354 format ( /,  11h more pipe.,  24h     ncc     nc1     ixa,
     1  13x,  7hreal-s1,  13x,  7himag-s1,
     2  13x,  7hreal-s2,  13x,  7himag-s2  ,/,  11x,  3i8,  4e20.11 )
      do 65 i=1,nc1
      zp(i,ncc) = czero
      zp(ncc,i) = czero
      zpc(i,ncc)=s2
   ...
   65 continue
      ...
      zpc(ncc,ncc)=zzo
   90 if ( iprs47  .ge.  1 )
     1 write (logsix, 3368)  usp, pai, u2p, e2p, su0
 3368 format ( /,  16h exit  'ptzy2' .,  16x,  3husp,  16x,  3hpai,
     1 16x,  3hu2p,  16x,  3he2p,  11x,  8hreal-su0,
     2 11x,  8himag-su0  ,/,  16x,  6e19.10 )
      return
      end
     ...
     1      integer*4 (i-n)
      ...
      y = x/cmplxz(c1, fzero)
      if ( iprs47  .ge.  5 )
     1 write (logsix, 3426)  kn, ikm, ixa, x, y, xa
 3426 format ( /,  17h begin  'bsikm' .,  24h      kn     ikm     ixa,
     1 9x,  6hreal-x,  9x,  6himag-x,  9x,  6hreal-y,  9x,  6himag-y,
     2 13x,  2hxa  ,/,  17x,  3i8,  5e15.6  )
      ...
      y5=y4*y1
      y6=y5*y1
      bi0=1.+3.5156229*y1+3.0899424*y2+1.2067492*y3+0.2659732*y4+0.03607
     268*y5+0.0045813*y6
      bj1=x*(0.5+0.87890594*y1+0.51498869*y2+0.15084934*y3+0.02658733*y4
     2+0.00301532*y5+0.00032411*y6)
      go to 29
   25 y0=csqrtz(x)
      ...
      y7=y6/y
      y8=y7/y
      bi0=(0.39894228+0.01328592*y1+0.00225319*y2-0.00157565*y3+0.009162
     281*y4-0.02057706*y5+0.02635537*y6-0.01647633*y7+0.00392377*y8)/y0
      bj1=(0.39894228-0.03988024*y1-0.00362018*y2+0.00163801*y3-0.010315
     255*y4+0.02282967*y5-0.02895312*y6+0.01787654*y7-0.00420059*y8)/y0
   29 if (xa .gt. c2)  go to 35
      ...
      y5=y4*y1
      y6=y5*y1
      bk0=-y0*bi0-0.57721566+0.42278420*y1+0.23069756*y2+0.03488590*y3+0
     2.00262698*y4+0.00010750*y5+0.00000740*y6
      bk1=y0*bj1+(1.+0.15443144*y1-0.67278579*y2-0.18156897*y3-0.0191940
     22*y4-0.00110404*y5-0.00004686*y6)/x
      go to 40
   35 y = cmplxz(c2, fzero) / x
      ...
      y4=y3*y
      y5=y4*y
      bk0=(1.25331414-0.07832358*y+0.02189568*y1-0.01062446*y2+0.0058787
     22*y3-0.00251540*y4+0.00053208*y5)/y0
      bk1=(1.25331414+0.23498619*y-0.03655620*y1+0.01504268*y2-0.0078035
     23*y3+0.00325614*y4-0.00068245*y5)/y0
   40 bbin(1) = bi0
      bbin(2)=bj1
      bbkn(1)=bk0
      bbkn(2)=bk1
      if ( iprs47  .ge.  5 )
     1 write (logsix, 3452)  bi0, bj1, bk0, bk1
 3452 format ( /,  9h scalars.,
     1  7x,  8hreal-bi0,  7x,  8himag-bi0,
     2  7x,  8hreal-bj1,  7x,  8himag-bj1,
     3  7x,  8hreal-bk0,  7x,  8himag-bk0,
     4  7x,  8hreal-bk1,  7x,  8himag-bk1  ,/,  9x,  8e15.6  )
   ...
   70 if ( iprs47  .ge.  6 )
     1 write (logsix, 3476)  ( l, bbin(l), bbkn(l), l=1, kn )
 3476 format ( /,  18h exit    'bsikm' .,  5x,  3hrow,
     1  11x,  9hreal-bbin,  11x,  9himag-bbin,
     2  11x,  9hreal-bbkn,  11x,  9himag-bbkn,
     3  /,  (  18x,  i8,  4e20.11 )  )
      return
      end
      subroutine  olzy( w,ncpp,zy,dij,ang,usi,usr,esi,hi,di,zs,ze,zc,
     1                  ldm,ldn )
      implicit real*8 (a-h, o-z) ,
     1      integer*4 (i-n)
      include  'labl47.ftn'
      ...
      ss = csqrtz ( s )
      if ( iprs47  .ge.  1 )
     1 write (logsix, 3508)  iearth, ncct, u2p, w, ss
 3508 format ( /,  16h begin  'olzy' .,  16h  iearth    ncct,
     1  17x, 3hu2p, 19x, 1hw,
     2  13x,  7hreal-ss,  13x,  7himag-ss  ,/,  16x,  2i8,  4e20.11 )
      ll1 = 1
      do 20  i=1, npc
      do 20  j=1, npc
      if ( j  .lt.  i )   go to 20
   ...
   20 continue
      if ( iprs47  .ge.  2 )
     1 write (logsix, 3523)  ncct, npc, u0, roe
 3523 format (
     1  63h diagnostic within  'olzy' .   ze(i,j)  for  (i,j)=1, ... npc
     2 .,  5x,  16h    ncct     npc,  13x,  2hu0,  12x,  3hroe  ,/,
     3  68x,  2i8,  2e15.6  )
      ll0 = 0
      if ( iprs47  .ge.  4 )
     1 call print ( ze(1,1), npc, ll0, ldn )
   ...
   35 zc(k,k) = xc
      if ( iprs47  .ge.  6 )
     1 write (logsix, 3541)  j, i, jnc, j2, j1, xc
 3541 format ( /, 33h inside  (j,i)  loop of  'olzy' .,
     1  40h       j       i     jnc      j2      j1,  13x,  7hreal-xc,
     2  13x,  7himag-xc  ,/,  33x,  5i8,  2e20.11  )
      jnc = j2 + 1
   40 continue
      if ( iprs47  .ge.  1 )
     1 write (logsix, 3554)
...
c
     ...
     1     integer*4 (i-n)
      ...
      if (iprs47 .ge. 1)
     1     write (logsix, 3611)  ncct, yyc(1,1), yyc(1,2)
 3611 format ( /,  " enter  'transp' .,  8h    ncct",
     1     7x,  'real-yyc(1,1)', 7x, 'imag-yyc(1,1)',
     2     7x,  'real-yyc(1,2)', 7x, 'imag-yyc(1,2)', /,  18x, i8,
     3     4e20.11, /, ' diagnostic input matrix.   y
     4yc(i,j)  for  (i,j)=1, ... i2 .')
      i2 = 6
      ll0 = 0
      if ( iprs47  .ge.  4 )
     1     call print ( yyc(1,1), i2, ll0, ldn )
      i2 = 0
      do 100 k=1, ncct
         k1 = (k-1)*4 + 1
         j1 = i2 + 1
 ...
 100  continue
      if ( iprs47  .ge.  1 )
     1     write (logsix, 3623)  yyc(1,1), yyc(1,2)
 3623 format ( /,  " exit  'transp' .",
     1     7x,  'real-yyc(1,1)', 7x, 'imag-yyc(1,1)',
     2     7x,  'real-yyc(1,2)', 7x, 'imag-yyc(1,2)',
     3     /, 17x, 4e20.11 , /,
     4     ' diagnostic output matrix.  y
     4yc(i,j)  for  (i,j)=1, ... i2 .')
      if (iprs47 .ge. 4)
     1     call print(yyc(1, 1), i2, ll0, ldn)
      return
...
c
 ...
 3672 format ( /,  18h begin  'skin47' .,  18x,  2hb1,  18x,  2hb2,
     1  17x,  3hd15,  18x,  2hxa,  18x,  2hxb  ,/,  18x,  5e20.11  )
...
cccc  d2 = 50.
 ...
 3688 format ( /,  17h exit  'skin47' .,  18x,  2hur,
     1  12x,  8hreal-cjw,  12x,  8himag-cjw,
     2  12x,  8hreal-zcc,  12x,  8himag-zcc  ,/,  17x,  5e20.11  )
      return
      end
 ...
 3741 format ( /,  18h within  'zegen' .,  16h   isyst     ixa,
     1  16x,  3hbe1,  16x,  3hbe2,  17x,  2hxa,  17x,  2hth,
     2  16x,  3hxa1  ,/,  18x,  2i8,  5e19.10  ,/,  1x,
     3  13x,  7hreal-xe,  13x,  7himag-xe,
     4  19x, 1hw, 19x, 1he,/, 1x, 4e20.11 )
      if ( e  .gt.  5.)   go to 60
      r2 = e ** 4
      r1=r2/16.
      sn = e**2/8.
 ...
 3782 format ( /,  16h exit  'zegen' .,
     1  17x, 2hp1, 17x, 2hq1,
     2  12x,  7hreal-xe,  12x,  7himag-xe  ,/,  16x,  4e19.10  )
      return
      end
...
!     eigenvalue calculation subroutine.   'kvalue'  =  iteration limit.
 ...
 3806 format ( /,  17h enter  'eigen' .,  8h       n,
  ...
  902 format(5x,36hwarning ; a higher accuracy can't be,
     1          27h achieved by this computer.,   /
     2 5x,42heigen values   1 vectors at itteration iq= ,
     3 i3,      12h is adopted.    )
      go to 63
   25 do 30 i=1,n
      do 30 j=1,n
...
!     non-64-bit complex math redefines tolerance in "sysdep":
 ...
 3842 format (  21h eigenvalue finished.,  8h       l,
     1  10x,  10hreal-qn(l),  10x,  10himag-qn(l),
     2  13x,  7hreal-ad,  13x,  7himag-ad  ,/,
     3  21x,  i8,  4e20.11  ,/,  1x  )
      go to 15
   90 dm=0.
      do 95 i=1,n
 ...
 3854 format ( /, 35h done all eigenvalues in  'eigen' .,
     1  18x,  2hdm,  14x,  6hspdlgt,  7x,  13hreal-p(im,im),
     2  7x,  13himag-p(im,im)  ,/,  35x,  4e20.11,   /,
     3  49h complex eigenvalues  (qn(i), i=1, n)  follow ...  ,/,
     4  ( 1x,  6e20.11 )  )
      if ( iprs47  .ge.  1 )
     1 write (logsix, 3867)
 3867 format ( /,  88h diagnostic upon exit  'eigen' .   matrix of eigen
     1vectors  a(i,l)  for  (i,l)=1, ... n .    )
      ll0 = 0
      if ( iprs47  .ge.  6 )
 ...
 3917 format ( /,  16h enter  'zest' .,  18x,  2hh1,  18x,  2hh2,
     1  19x,  1he,  17x,  3hres,  17x,  3homg  ,/,  16x,  5e20.11  )
      hkr = spdlgt**2
      yud=1./toj/hkr
      h1ph2=h1+h2
      ab = 10. * e/h1ph2
 ...
 3928 format ( /,  1x,  8h       l,  18x,  2hbp,  18x,  2hab,
     1  17x,  3hram,  16x,  4hrmax,  14x,  6hreal-z,  14x,  6himag-z
     2  ,/,  1x,  i8,  6e20.11  )
      go to (702,701),l
  701 u1=z
      jd=50
 ...
 3943 format ( /,  1x,  14x,  2hdx,  11x,  5hhtoj2,  12x,  4hrmin,
     1  12x,  4homg2,  13x,  3htoj,  10x,  6hvalue5,  9x,  7hreal-qq,
     2  9x,  7himag-qq  ,/,  1x,  8e16.7  )
   75 dx2=dx
      dx=dx/2.0
      ram=rmin+dx
      n=2*n
 ...
 3956 format ( /,  13h bottom loop.,  8h       n,  19x,  1hr,
     1  18x,  2hdx,  17x,  3hram,  13x,  7hreal-qq,  13x,  7himag-qq
     2  ,/,  13x,  i8,  5e20.11  )
      if ( r .le. v5)   go to 50
      sq1 = sq3
      go to 75
 ...
 3968 format ( /,  15h exit  'zest' .,  17x,  3homg,  14x,  6hvalue2,
     1  14x,  6hreal-s,  14x,  6himag-s  ,/,  15x,  4e20.11  )
      return
      end
...
ccc!    4 f(i,j) = d2
 ...
 4005 format ( /,  16h start  'minv' .,  8h       m,  14x,  6hvalue6,
     1  18x,  2hd1,  9x,  11hreal-f(1,1),  9x,  11himag-f(1,1)  ,/,
     2  16x,  i8,  4e20.11  ,/,
     3  47h diagnostic   tcmpx(i,j)  for  (i,j)=1, ... m .    )
      ll0 = 0
      if ( iprs47  .ge.  7 )
...
!     1                              k1, n, d9, d1
 ...
 5706 format ( /, 106h stop. ---- matrix inversion within subroutine  'm
     1inv'  has been suspended, due to failure to find a large     ,/,
     2        12x,  58henough pivot element.   the matrix in question is
     3 of order,  i5,  36h ,    with breakdown having occurred     ,/,
     4       12x,  51hwhile working on the elimination of variable numbe
     5r,  i5,   '.   in this columns, the largest real or'       ,/,
     6       12x,  ' imaginary part had absolute value',
 ...
 5707 format (12x,  11his equal to,   e14.3,   36h .    this latter numb
     1er is equal to,   e14.3,   20h   times the largest           ,/,
     2       12x,  67helement of the original input matrix (considering
     3absolute values).     )
      stop
...
ccc!     d = f(i,k1)
      ...
      di = fi(i,k1)
      do 95   j=k1, m1
cccc  f(i,j) = f(i,j) - d/f(k1,k1) * f(k1,j)
...
!     2    i, j, j1, fr(i,j1), fi(i,j1), tcmpx(i,j)
 ...
 4027 format ( /,  24h exit  'minv'  normally.,
     1  5x,  15hreal-tcmpx(1,1),  5x,  15himag-tcmpx(1,1),
     2  5x,  15hreal-tcmpx(1,2),  5x,  15himag-tcmpx(1,2)  ,/,
     3  24x,  4e20.11  ,/,
     4  55h diagnostic inverse.   tcmpx(i,j)  for  (i,j)=1, ... m.  )
      if ( iprs47  .ge.  7 )
     1 call print ( tcmpx(1,1), m, ll0, ldn )
  150 return
      end
 ...
 4062 format ( /,  15h enter  'mxm' .,  8h       n,
     1  7x,  13hreal- xm(1,1),  7x,  13himag- xm(1,1),
     2  7x,  13hreal-yym(1,1),  7x,  13himag-yym(1,1)  ,/,
     3  15x,  i8,  4e20.11  ,/,
     4  57h diagnostic left factor.   xm(i,j)  for  (i,j)=1, ... n .  )
      if ( iprs47  .lt.  8 )   go to 4079
      ll0 = 0
      call print ( xm(1,1), n, ll0, ldn )
      write (logsix, 4073)
 4073 format ( /,
     1  58h diagnostic right factor.  yym(i,j)  for  (i,j)=1, ... n . )
 ...
 4091 format ( /,  14h exit  'mxm' .,
     1  9x,  11hreal-c(1,1),  9x,  11himag-c(1,1),
     2  9x,  11hreal-c(1,2),  9x,  11himag-c(1,2)  ,/,
     3  14x,  4e20.11  ,/,
     4  52h diagnostic product.   c(i,j)  for  (i,j)=1, ... n .   )
      if ( iprs47  .ge.  8 )
