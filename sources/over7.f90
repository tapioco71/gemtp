...
1120 isubs1 =  iofkor+js
  ...
  js = korder(isubs1)
1130 icon = 0
1140 if (js .eq. 0)   go to 200
1150 isubs1 =  iofkol+js
...
9996 lstat(18)=7
  ...
  nchain = 51
  if ( iprsup  .ge.  1 ) write (lunit6, 4568 )
99999 if (associated (ndex)) nullify (ndex)
  return
