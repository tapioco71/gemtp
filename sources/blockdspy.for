  ...
  block data blkhlp
     ...
     data  texspy (  15 )   /  '  "timespan"  computation is now automa tically performed,  internally.   at  any'  /
     data  texspy (  16 )   /  '  level,  "stop"  no longer terminates program execution, but instead it returns'  /
     data  texspy (  17 )   /  '  control to the  "spy:"  prompt.   con tinuous,  automatic plotting  of  the on-'  /
     ...
     data  texspy (  65 )   /  '  this command is the gateway to instal lation-dependent commands which are non- '  /
     data  texspy (  66 )   /  '  standard,  and which have been instal led locally.   the  utpf carries a dummy '  /
     ...
     data  texspy (  70 )   /  '  when the EMTP is in the time-step loo p, this command will force an exit to    '  /
     data  texspy (  71 )   /  '  overlay 20 upon completion of present time-step.   there,  "katalg"  saves    '  /
     data  texspy (  72 )   /  '  EMTP tables as rapidly as possible (m ay not be permanent).   the simulation   '  /
     data  texspy (  73 )   /  '  then recommences by an automatic tran sfer back to the beginning of the        '  /
     data  texspy (  74 )   /  '  time-step loop ("over16").   since pl ot data points are not part of the       '  /
     data  texspy (  75 )   /  '  saving, if the user wants these to be preserved, too, he must be careful.     '  /
     data  texspy (  76 )   /  '  provided EMTP storage for plot data p oints does not fill up before the        '  /
     data  texspy (  77 )   /  '  subsequent  restore  operation (to ba ck up time to the  save  point), there   '  /
     data  texspy (  78 )   /  '  is no problem.  otherwise, consider u se of  "space"  and  "lunit4"  commands. '  /
     data  texspy (  79 )   /  'key word no. 10:  "restore"     ----  - ---  ----                                '  /
     data  texspy (  80 )   /  '  the  "restore"  command is the revers e of  "save".  when within the deltat    '  /
     ...
     data  texspy ( 191 )   /  '  case,  "erexit"  reads and removes su    ch data cards, creating special reserved '  /
     ...
     data  texspy ( 281 )   /  '  next card which has a non-blank colum n 80.   after display of this record,    '  /
     ...
     data  texspy ( 355 )   /  '  to abort the file-name prompt after t he  "control"  definitions (in case the  '  /
     data  texspy ( 356 )   /  '  user only wants to redefine the  luni t5  usage pointer, for example).   a     '  /
     ...
     data  texspy ( 408 )   /  '  every twentieth time-step, he would send function much"7"  in response to the prompt for a'  /
