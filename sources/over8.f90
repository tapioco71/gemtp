...
14000 if (iprsup .ge. 1) write (unit = lunit(6), fmt =  14100)  istart,istep,loopss(1),loopss(2), loopss(4),loopss(8),loopss(9),loopss(10),kconst,ibr, &
