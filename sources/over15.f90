...
3108 format (/, ' Column headings for the', i4, '  EMTP output variables follow.   These are ordered according to the five', /, &
...
3122 format (' Branch power  consumption (power  flow, if a switch) is treated like a branch voltage for this grouping|', /, &
...
8888 format (/, ' Error stop. Something has gone wrong with setting up the compensation tables in module', &
          ' "uminit" for um -', i4, '. Consult EMTP', /, ' management after making sure that you did', &
